...
function adicionarPet(){
  ...
  const pet = { id: nextPetId++, clienteId: parseInt(clienteId), clienteNome: cliente?cliente.nome:'—',
    ...
    cartaoVacinaNumero: cartao, observacoes, imagens: [], dataCadastro: new Date().toLocaleDateString('pt-BR') };
  pets.push(pet);
  atualizarTabelaPets(); preencherPetsEmGaleria(); limparFormularioPet(); alert('Pet cadastrado com sucesso!'); saveState();
}
